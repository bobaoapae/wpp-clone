<template>
    <div class="landing-wrapper" id="qr-code">
        ...
        <div class="landing-window">
            <div class="landing-main">
                ...
                <div class="box-info">
                    <div class="landing-title _2lAHA">Para usar o WhatsApp no seu computador:</div>
                    <ol class="_1TxZR">
                        <li class="_1Fl07">Abra o WhatsApp em seu celular</li>
                        <li class="_1Fl07">
                                <span
...
.landing-wrapper {
    min-width: 520px;
    height: 100%;
    background: linear-gradient(#1ebea5 200px, #d8dbd5 0%);
}
